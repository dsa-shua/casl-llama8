...
class LlamaDecoderLayer(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        with profile(activities=[ProfilerActivity.CUDA], record_shapes=True, profile_memory=True, with_stack=True, with_flops=True, with_modules=True) as block_prof:
        ...
        with open(f"/root/casl/llama/results/block.txt", "w") as file:
            file.write(block_prof.key_averages().table(sort_by="cuda_time_total"))
